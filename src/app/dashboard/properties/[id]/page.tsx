        ...
        <div>
          ...
          <div className="detail-card" style={{marginBottom:20}}>
            ...
            {editMode ? (<>
              ...
              <div className="form-row">
                <div className="form-group"><label>Tip</label><select className="form-select" value={editForm.type||''} onChange={e=>setEditForm({...editForm,type:e.target.value})}><option>Novogradnja</option><option>Sekundarni Stanovi</option><option>Kuće</option><option>Lokali</option><option>Rente</option></select></div>
